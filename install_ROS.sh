...
sudo apt update
sudo apt install cmake=3.31.5-0kitware1ubuntu20.04.1 cmake-data=3.31.5-0kitware1ubuntu20.04.1  -y --allow-downgrades
# pin the version to prevent automatic updates that might break the build
